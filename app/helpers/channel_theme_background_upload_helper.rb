module ChannelThemeBackgroundUploadHelper
  ...
  def s3_channel_theme_background_uploader(options = {})
    ...
    out << javascript_tag("$(function() {
      ...
      // image uploader via plupload
        var uploader = new plupload.Uploader({
                                                runtimes : 'flash',
                                                browse_button : 'channel_background_selector',
                                                max_file_size : '5mb',
                                                url : base_url,
                                ...
                                uploader.bind('FileUploaded', function(up, file) {
                                  ...
                                  if(count==0 && file.status == plupload.DONE){
                                    ...
                                    aw_notify_channel_theme_background(main_url, thumb_url);
                                  }
                                });
