...
ActiveRecord::Schema.define(:version => 20111223201844) do
  ...
  create_table "activities", :force => true do |t|
    ...
    t.text     "category_id"
    t.text     "actions"
    t.datetime "backup_created_timestamp", :default => '2012-02-10 06:12:57'
  ...
  create_table "documents", :force => true do |t|
    ...
    t.datetime "backup_created_timestamp", :default => '2012-02-10 06:13:00'
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "hubs", :force => true do |t|
    ...
    t.integer  "status_at_source"
    t.text     "category_type"
    t.datetime "backup_created_timestamp", :default => '2012-02-10 06:12:58'
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "tags", :force => true do |t|
    ...
    t.integer  "status_at_source"
    t.integer  "status",                                                      :null => false
    t.datetime "backup_created_timestamp", :default => '2012-02-10 06:13:05'
    t.datetime "created_at"
    t.datetime "updated_at"
  end
