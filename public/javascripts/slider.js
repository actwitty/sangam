...
var simpleGallery_navpanel={
	loadinggif: '/images/actwitty/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'45px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ '/images/actwitty/left.gif', '/images/actwitty/play.gif', '/images/actwitty/right.gif', '/images/actwitty/pause.gif'], //nav panel images (in that order)
...
simpleGallery.prototype={
	...
	showslide:function(keyword){
		...
		setting.$gallerylayers.eq(setting.bglayer).css({zIndex:1000, opacity:0}).stop().css({opacity:0}).animate({opacity:1}, setting.fadeduration, function(){ 
...
simpleGallery.routines={
	...
	addnavpanel:function(setting){
		...
		$('<div class="navpanelbg"></div><div class="navpanelfg"></div>') 
			...
			.eq(1).css({paddingTop:simpleGallery_navpanel.panel.paddingTop, textAlign:'center', color:'white'}).html(interfaceHTML).end().appendTo(setting.$navpanel);
