...
function initialize() {
  ...
  google.maps.event.addListener(autocomplete, 'place_changed', function() {
    ...
    */
    ...
    document.getElementById('lat_value').value = map.getCenter().lat();
    document.getElementById('lng_value').value = map.getCenter().lng();
    document.getElementById('geo_location').value = document.getElementById('location_field').value;
