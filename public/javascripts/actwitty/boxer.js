...
var the_big_json_renderers={
                              "image" : function aw_boxer_render_image(data, internal_id){
                                                 return aw_render_image_internal(data, internal_id);
                                                },
 ...
 *
 */
function  render_internal_html(data, internal_id, type){
  var html = "";
    
  if( the_big_json_renderers[type] ){
    html = the_big_json_renderers[type]( data, internal_id);
  }
...
function addtab(box_id, position, data, type, boxer_class)
{
  ...
  var content_html = render_internal_html( data, internal_id, type);
