var aw_local_users_channels_data = {
                                      ...
                                      'Cars' :           {'category':'cars'},
                                      'Motorbikes' :     {'category':'cars'},
                                      'Cycles' :         {'category':'cars'},
                                      'Mycar' :          {'category':'cars'},
                                      'CarMaintenance' : {'category':'cars'},
                                      'Driving' :        {'category':'cars'},
                                      'RoadTrip' :       {'category':'cars'},
                                      'BuyingACar' :     {'category':'cars'},
                                      'DreamCar' :     {'category':'cars'},

                                      'celebrations' :  {'category':'events'},
                                      'birthdays' :  {'category':'events'},
                                      'thanksgiving' :  {'category':'events'},
                                      'newyears' :  {'category':'events'},
                                      'christmas' :  {'category':'events'},
                                      'GoodFriday' :  {'category':'events'},
                                      'EasterSunday' :  {'category':'events'},
                                      'YomKippur' :  {'category':'events'},
                                      'Sabbath' :  {'category':'events'},
                                      'IndependenceDay' :  {'category':'events'},
                                      'Eid' :  {'category':'events'},
                                      'anniversary' :  {'category':'events'},
                                      'diwali' :  {'category':'events'},
                                      'Onam' :  {'category':'events'},
                                      'Pongal' :  {'category':'events'},
                                      ...
                                      'MensAccessories' :       {'category':'fashion'},
                                      'WomensAccessories' :       {'category':'fashion'},
                                      'Cosmetics' :       {'category':'fashion'},
                                      'FashionBrands' :       {'category':'fashion'},
                                      'Jwellery' :       {'category':'fashion'},
                                      'HairStyling' :       {'category':'fashion'},
                                      'Shoes' :       {'category':'fashion'},
                                      'Bags' :       {'category':'fashion'},
                                      'Watches' :       {'category':'fashion'},
                                      'Bangles' :       {'category':'fashion'},
                                      ...
                                      'NorthAmerica' :        {'category':'travel'},
                                      'Asia' :        {'category':'travel'},
                                      'Africa' :        {'category':'travel'},
                                      'Australia' :        {'category':'travel'},
                                      'SouthAmerica' :        {'category':'travel'},
                                      'China' :        {'category':'travel'},
                                      'Hills' :        {'category':'travel'},
                                      'Seas' :        {'category':'travel'},
                                      'HotelsAndStays' :        {'category':'travel'},
                                      'Vaccations' :        {'category':'travel'},
                                      'Flying' :        {'category':'travel'},
                                   };
