...
function addtab(box_id, position, data, type, boxer_class)
{
  ...
  var close_html = '<a href="" id="' + close_btn_id + '" class="boxer_close js_aw_ntabs_close">' +
                        '<img src="/images/fancy_close.png">' +
                      '</a>';
...
function aw_channels_render_all_modal(win_id, trigger_id){
  ...
  var search_html = '<div class="search_box">' +
                      ...
                      '<li><label class="lab_search_box">Search on channels to set filter</label></li>' +
...
$(document).ready(function(){
  /* Manage summary filters */
    ...
    $('#more_personal').click(function() {
      ...
      append_personal_summary(aw_lib_get_page_owner_id());
      return false;
    });
    /***********************/
...
function handle_like_campaign(div_id, stream){
 ...
 if (user_status == true){
  ...
  var html = '<div class="p-awp-view-campaign_all ">' +
             ...
             '<a id="' + link + '" value="' + div_id + '" class=" button_actwitty green  js_like_user_action actwitty_button_font">' +
                  like_text +
             '</a>' +
             '</div>' +
...
function create_and_add_stream(streams_box, stream, current_user_id, prepend){
  ...
  var subtitle_box_id = stream_render_id + '_subtitle';
                   ...
                   '</div>'+
                    ...
                    '<div class="p-awp-post-opt" >' +
                     ...
                     '<div class="p-awp-post-const-opt">' +
                        '<div class="js_stream_enrich_btn p-awp-post-mentions hover_point button_actwitty actwitty_button_font rosy"> Mentions </div> '+
